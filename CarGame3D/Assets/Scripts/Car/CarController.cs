...
{
    [SerializeField] private WheelColliders _wheelColliders;    // aracin tekerlek colliderlerinin bulundugu sinifi newliyoruz
    ...
    [SerializeField] private AnimationCurve steeringCurve;  //arac hizli giderken daha az, yavas giderken daha cok direksiyon donus acisi olsun diye kullandigim degisken (100 birim hizla giderken 5 derece -
    ...
    private void CalculateSpeed()           // Aracin hizini hesapladigimiz fonksiyon
    {
    ...
    private void CheckParticles() // Particlelerin olusma zamanini kontrol ediyoruz
    {
        ...
        float slipAllowance = 0.5f;   // tekerlerin particle sacmadan once kaymasina izin verilen miktar
