...
public class EngineAudio : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        runningAudio.pitch = Mathf.Lerp(runningAudio.pitch, Mathf.Lerp(0.3f, runningMaxPitch, speedRatio), Time.deltaTime); // ic ice lerp komutu ile aracin sesinin pitch degerini cok daha
